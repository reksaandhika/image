...
import githubLogo from './imgs/github-logo.svg?url';
import largePhoto from './imgs/demos/demo-large-photo.jpg?url';
import artwork from './imgs/demos/demo-artwork.jpg?url';
import deviceScreen from './imgs/demos/demo-device-screen.png?url';
import largePhotoIcon from './imgs/demos/icon-demo-large-photo.jpg?url';
import artworkIcon from './imgs/demos/icon-demo-artwork.jpg?url';
import deviceScreenIcon from './imgs/demos/icon-demo-device-screen.jpg?url';
import smallSectionAsset from './imgs/info-content/small.svg?url';
import simpleSectionAsset from './imgs/info-content/simple.svg?url';
import secureSectionAsset from './imgs/info-content/secure.svg?url';
import logoIcon from './imgs/demos/icon-demo-logo.png?url';
import logoWithText from './imgs/logo-with-text.svg?data-url-text';
